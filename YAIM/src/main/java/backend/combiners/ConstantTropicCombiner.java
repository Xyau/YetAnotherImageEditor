...
public class ConstantTropicCombiner implements Combiner{
	Double std;
	...
	public ConstantTropicCombiner(Double std) {
		this.std = std;
	}
	...
	public DenormalizedColor combine(List<DenormalizedColorPixel> colorPixels, Double[][] filter) {
		...
		DenormalizedColor upC = new DenormalizedColor(0.5,0.5,0.5,1.0);
		DenormalizedColor downC = new DenormalizedColor(0.5,0.5,0.5,1.0);
		DenormalizedColor rightC = new DenormalizedColor(0.5,0.5,0.5,1.0);
		DenormalizedColor leftC = new DenormalizedColor(0.5,0.5,0.5,1.0);
	...
	public boolean equals(Object o) {
		...
		ConstantTropicCombiner that = (ConstantTropicCombiner) o;
