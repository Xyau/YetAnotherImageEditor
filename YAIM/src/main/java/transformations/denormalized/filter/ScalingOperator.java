...
public class ScalingOperator implements DenormalizedTransformation {
    ...
    public ScalingOperator(Double[][] filter, Combiner combiner){
    ...
    public boolean equals(Object o) {
        ...
        ScalingOperator that = (ScalingOperator) o;
